        ...
        >
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14">
                <div className="sm:col-span-2 lg:col-span-1">
                    <a href="/" className="text-3xl font-bold text-white hover:text-indigo-400 transition">
                        SmartFolio
                    </a>
                    <p className="text-sm/7 mt-6">AI-powered portfolio generation platform that transforms your professional data into stunning portfolios with personalized coaching insights.</p>
                </div>
